    ...
    <div class="container">
        <div class="row">
            <div class=" col-md-4 col-sm-4 col-xs-12">
                <a class="info-contact" href="tel:0985673110">
                    <i class="fas fa-phone-alt"></i>0985673110
                </a>
                <a class="info-contact" href="mailto:truongdu@gmail.com">
                    <i class="far fa-envelope"></i> truongdu@gmail.com
                </a>
            </div>
